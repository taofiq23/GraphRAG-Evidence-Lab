...
\title{\textbf{Retrieval Succeeds, Reasoning Fails:} \\[0.4em] \textbf{Disentangling Bottlenecks in Multi-Hop Knowledge Graph \\ Question Answering with Small Language Models}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\linewidth]{accuracy_by_hop.pdf}
...
Hyung Won Chung, Le Hou, et al.
\newblock Scaling Instruction-Finetuned Language Models.
\newblock \emph{arXiv preprint arXiv:2210.11416}, 2022.

\bibitem[Edge et al.(2024)]{edge2024graphrag}
Darren Edge, Ha Trinh, Newman Cheng, Joshua Bradley, Alex Chao, Apurva Mody, Steven Truitt, Jonathan Larson, et al.
...
\newblock In \emph{International Conference on Learning Representations (ICLR)}, 2023. arXiv:2210.03629.
